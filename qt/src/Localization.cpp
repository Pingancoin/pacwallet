...
QMap<QString, QString> zhTranslations()
{
    return {
        ...
        {QStringLiteral("Native desktop wallet for balances, transfers, receive addresses, and multisig."), QStringLiteral("用于余额、转账、收款地址和多签的原生桌面钱包。")},
        ...
        {QStringLiteral("Wallet Sync"), QStringLiteral("钱包同步")},
        {QStringLiteral("Transaction Detail"), QStringLiteral("交易详情")},
        {QStringLiteral("Receive QR"), QStringLiteral("收款二维码")},
        {QStringLiteral("A local wallet already exists."), QStringLiteral("本地钱包已经存在。")},
        {QStringLiteral("A local wallet already exists at %1"), QStringLiteral("本地钱包已经存在：%1")},
        {QStringLiteral("A local wallet already exists. Opened the current wallet instead."), QStringLiteral("本地钱包已经存在，已打开当前钱包。")},
        {QStringLiteral("Unable to connect to the local wallet service."), QStringLiteral("无法连接本地钱包服务。")},
        {QStringLiteral("Unable to resolve the wallet node address."), QStringLiteral("无法解析钱包节点地址。")},
        {QStringLiteral("The network request timed out."), QStringLiteral("网络请求超时。")},
        ...
        {QStringLiteral("Wallet Already Exists"), QStringLiteral("钱包已存在")},
        ...
        {QStringLiteral("Open Wallet File"), QStringLiteral("打开钱包文件")},
        {QStringLiteral("Wallet Status"), QStringLiteral("钱包状态")},
        {QStringLiteral("Wallet Details"), QStringLiteral("钱包信息")},
        {QStringLiteral("Appearance"), QStringLiteral("外观")},
        {QStringLiteral("Wallet Version"), QStringLiteral("钱包版本")},
        ...
        {QStringLiteral("Choose how the wallet interface is displayed on this computer."), QStringLiteral("选择这台电脑上钱包界面的显示语言。")},
        ...
        {QStringLiteral("Switch language, review wallet information, and harden wallet security."), QStringLiteral("切换语言、查看钱包信息，并加强钱包安全。")},
        ...
        {QStringLiteral("A local wallet is already loaded from %1. Open Overview to use it, or restore another wallet with overwrite enabled."), QStringLiteral("已从 %1 载入本地钱包。请打开总览使用，或勾选覆盖后恢复另一个钱包。")},
        {QStringLiteral("the current wallet folder"), QStringLiteral("当前钱包文件夹")},
