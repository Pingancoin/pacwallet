...
Name: "{autoprograms}\Pingancoin Wallet (Web Service)"; Filename: "{app}\pacwallet.exe"; Parameters: "serve --network mainnet --walletdir ""{userprofile}\.pacwallet"" --rpc https://rpc.pingancoin.org/rpc --listen 127.0.0.1:19709"; WorkingDir: "{app}"; IconFilename: "{app}\branding\pingancoin-icon.ico"
